/*
 * project: 29_spi_slave_i2c_oled
 * Simultaneously test the SPI and I2C peripherals of an ESP32-C3 Mini with 0.42" OLED I2C display
 * This is the SPI salve device which must be connected to a master SPI device.
 * 
...
void setup() {
  ...
  Serial.println("\nProject: 28_spi_slave_i2c_oled");
  Serial.println("Purpose: Simultaneously test the SPI and I2C peripherals of an ESP32-C3 Mini with 0.42\" OLED I2C display");
  Serial.println("          This is the SPI slave device which must be connected to a master SPI device");
  Serial.print(  "  Board: ");
  #ifdef ARDUINO_BOARD
